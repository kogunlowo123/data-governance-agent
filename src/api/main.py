"""Data Governance Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Data governance agent that manages data catalogs, enforces access policies, classifies sensitive data, tracks data ownership, and ensures compliance with data regulations across the organization.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
